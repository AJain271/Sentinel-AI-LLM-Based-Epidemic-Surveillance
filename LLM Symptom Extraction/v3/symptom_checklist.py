"""
Builds the known symptom checklist for v3 extraction.
...
symptoms on this known list — novel hallmarks must be discovered as
unmapped symptoms via quote-binding.
"""
